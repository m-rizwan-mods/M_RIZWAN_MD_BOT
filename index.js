...
app.get('/pair', (req, res) => {
    ...
    <head>
        ...
        <style>
            ...
            .box{background:#1e293b;padding:30px;border-radius:15px;max-width:400px;margin:auto}
            input{padding:12px;width:90%;border:none;border-radius:8px;margin:10px 0;font-size:16px}
            button{padding:12px 25px;background:#22c55e;border:none;border-radius:8px;color:white;font-size:16px;cursor:pointer}
    ...
    <body>
        <div class="box">
            <h2>🤖 M-RIZWAN-MD PAIRING</h2>
            <p>WhatsApp Number likho country code ke sath</p>
            <p>Example: 923436259742</p>
            <input id="number" type="text" placeholder="923xxxxxxxxx">
            <br>
        ...
        async function getCode(){
            ...
            document.getElementById('result').innerHTML = '⏳ Code bana raha hu...';
            ...
            if(data.code){
                document.getElementById('result').innerHTML = '✅ Your Code: <b>' + data.code + '</b><br><br>WhatsApp > 3 dots > Linked Devices > Link with phone number';
            } else {
